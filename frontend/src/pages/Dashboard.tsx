...
const metricCards: MetricCard[] = [
  ...
  { title: 'Due Amount', value: '₹45,678', icon: '💰', color: '#F44336' },
  { title: 'Paid Amount', value: '₹89,012', icon: '💵', color: '#4CAF50' },
  { title: 'Purchase Amount', value: '₹67,890', icon: '🛒', color: '#FF9800' },
  { title: 'Sales Amount', value: '₹1,23,456', icon: '📈', color: '#4CAF50' },
  { title: 'Expense Amount', value: '₹34,567', icon: '💸', color: '#F44336' },
  ...
  { title: 'Bank Deposit', value: '₹2,34,567', icon: '🏦', color: '#4CAF50' },
  { title: 'Customer Deposit', value: '₹1,56,789', icon: '💳', color: '#2196F3' },
  { title: 'Suppliers Deposit', value: '₹78,901', icon: '💳', color: '#9C27B0' },
];
