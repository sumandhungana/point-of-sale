...
interface YouReceivedSupplierProps {
    supplierId?: number;
    onSuccess: () => void;
    onClose: () => void;
}

export const YouReceived: React.FC<YouReceivedSupplierProps> = ({ supplierId, onSuccess, onClose }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await createPayment({
                ...
                paymentCategory: 'RECEIVED', // "You Received" mapping for Supplier
